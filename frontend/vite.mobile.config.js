...
export default defineConfig(({ mode }) => {
  ...
  return {
    plugins: [
      frappeui({
        frappeProxy: false, // Disable proxy for mobile build
        lucideIcons: true,
        jinjaBootData: false, // Disable Jinja for mobile build
        frappeTypes: {
          input: {},
        },
        buildConfig: {
          indexHtmlPath: null, // Don't use Frappe's index.html for mobile
        },
      }),
      vue({
        script: {
